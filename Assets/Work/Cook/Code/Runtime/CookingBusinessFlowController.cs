...
namespace Work.Cook.Code.Runtime
{
    public sealed class CookingBusinessFlowController : MonoBehaviour
    {
        ...
        private bool _loggedMissingControls;
        ...
        private void EnsureControls()
        {
            ...
            if (_loggedMissingControls == false)
            {
                Debug.LogWarning("CookingBusinessFlowController no longer creates default controls. Assign action root, status field, and buttons in the inspector.", this);
                _loggedMissingControls = true;
            }
        }
